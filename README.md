# nvim-treesitter-queries-re2c

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-re2c/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-re2c/actions/workflows/validate.yml)

Neovim tree-sitter queries for **re2c**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-re2c",
...
- [ ] Changes are scoped to `re2c` — do not include files for other languages
